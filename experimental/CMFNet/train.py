...
sys.path.append('/opt/data/private/CMF_NET/')

from fastmri.data.mri_data import fetch_dir
from module_CMFNet import SRModule
...
def build_args():
    ...
    logdir = fetch_dir("log_path", path_config) / "cmfnet" / "2x_SR"
    ...
    num_gpus = 1
    backend = "dp"
    batch_size = 8 #if backend == "ddp" else num_gpus 24
    ...
    config = dict(
        ...
        num_pool_layers=4,
        drop_prob=0.0,
        mask_type="random",     # equispaced  random
